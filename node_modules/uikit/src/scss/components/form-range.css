...
Error: Undefined variable: "$global-color".
        on line 14 of /Users/woaiflinh/BRNDY/uniel/dist/node_modules/uikit/src/scss/components/form-range.scss

9: // Variables
10: // ========================================================================
11: 
12: $form-range-thumb-height:                        15px !default;
13: $form-range-thumb-border-radius:                 500px !default;
14: $form-range-thumb-background:                    $global-color !default;
15: 
16: $form-range-track-height:                        3px !default;
17: $form-range-track-background:                    darken($global-muted-background, 5%) !default;
18: $form-range-track-focus-background:              darken($global-muted-background, 15%) !default;
19: 

Backtrace:
/Users/woaiflinh/BRNDY/uniel/dist/node_modules/uikit/src/scss/components/form-range.scss:14
...
body:before {
  ...
  content: "Error: Undefined variable: \"$global-color\".\A         on line 14 of /Users/woaiflinh/BRNDY/uniel/dist/node_modules/uikit/src/scss/components/form-range.scss\A \A 9: // Variables\A 10: // ========================================================================\A 11: \A 12: $form-range-thumb-height:                        15px !default;\A 13: $form-range-thumb-border-radius:                 500px !default;\A 14: $form-range-thumb-background:                    $global-color !default;\A 15: \A 16: $form-range-track-height:                        3px !default;\A 17: $form-range-track-background:                    darken($global-muted-background, 5%) !default;\A 18: $form-range-track-focus-background:              darken($global-muted-background, 15%) !default;\A 19: "; }
